...
from Products.xxx_name_this.config import PROJECTNAME
from Products.xxx_name_this.config import product_globals as GLOBALS

def install(self):
    """ External Method to install xxx_name_this """
    out = StringIO()
    ...
    wft.setChainForPortalTypes( ['JoinIn'], "milieudefensie_workflow")
