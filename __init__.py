...
LOG('xxx_name_this',INFO, 'Installing Product')
...
from Products.xxx_name_this.config import *

DirectoryView.registerDirectory('skins', product_globals)
DirectoryView.registerDirectory('skins/xxx_name_this',
                                    product_globals)
...
def initialize(context):
    ...
    if CustomizationPolicy and hasattr(CustomizationPolicy, 'register'):
        ...
        print 'Customization policy for xxx_name_this installed'
