...
class StupidTransformReader:
    ...
    >>> for name in ('adviezen', 'nieuwsbrieven', 'persberichten'):
    ...
    >>> tuple(reader)
    ("'adviezen' called with 'blatabladbla'", "'nieuwsbrieven' called with 'nieuwsbrieffoo'", "'persberichten' called with 'hihipersberichten'")
