...
{
    var popup_template = 'referencebrowser_popup';
    if (fieldName == 'project') {
        popup_template = 'referencebrowser_popup_simple';
    }
    var link = path + '/' + popup_template + '?fieldName=' + fieldName + '&fieldRealName=' + fieldRealName +'&at_url=' + at_url;
    atrefpopup = window.open(link,'referencebrowser_popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=500,height=550');
}
